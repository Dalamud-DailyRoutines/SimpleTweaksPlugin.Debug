...
public class TargetDebugging : DebugHelper
{
    ...
    public override unsafe void Draw()
    {
        ...
        if (targets.FocusTarget != null)
            DebugManager.PrintOutObject(targets.FocusTarget, (ulong)targets.FocusTarget.Address.ToInt64(), new List<string> { "Target", "Focus" });
        ...
        if (targets.PreviousTarget != null)
            DebugManager.PrintOutObject(targets.PreviousTarget, (ulong)targets.PreviousTarget.Address.ToInt64(), new List<string> { "Target", "Prev" });
        ...
        if (targets.MouseOverTarget != null)
            DebugManager.PrintOutObject(targets.MouseOverTarget, (ulong)targets.MouseOverTarget.Address.ToInt64(), new List<string> { "Target", "MouseOver" });
