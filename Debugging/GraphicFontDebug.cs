...
public class GraphicFontDebug : DebugHelper
{
    ...
    {
        var styles = Enum.GetValues<GraphicFont.IconStyle>();
        ...
        foreach (var s in styles) ImGui.TableSetupColumn($"{s}", ImGuiTableColumnFlags.WidthFixed, maxWidthIcon * 2 * ImGuiHelpers.GlobalScale);
